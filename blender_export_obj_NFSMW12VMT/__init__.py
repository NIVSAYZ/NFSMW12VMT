...
bl_info = {
    "name": "Wavefront OBJ format (NFSMW12VMT)",
    "author": "Campbell Barton, Bastien Montagne, NIVSAYZ",
    "version": (3, 9, 0),
    "blender": (3, 0, 0),
...
def menu_func_export(self, context):
    self.layout.operator(ExportOBJ.bl_idname, text="Wavefront (.obj) (NFSMW12VMT)")
